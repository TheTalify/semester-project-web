        ...
        <div className="container-fluid">
          ...
          {/*<a href="index.html" style={{ paddingRight: "10px" }}>
            ...
            >
              ...
              <path
                class="ccustom"
                d="M13.583 19.9998C16.3555 18.6145 18.615 16.335  20.0002 13.5825C21.3855 16.355 23.6449 18.6145 26.4175 19.9998C23.6449 21.385 21.3855 23.6445 20.0002 26.417C18.615 23.6445 16.3555 21.385 13.583 19.9998Z"
                fill="#CA9352"
              ></path>
            </svg>
          </a>*/}
